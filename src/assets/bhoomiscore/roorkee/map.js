...
//           "/Bhoomiscore_Roorkee_fields/Roorkee_fields_bhoomiscore_monthly_ndvi.geojson"
//         );
...
//   const mapBounds = [
//     [29.8543 - 0.1, 77.8880 - 0.1], // southWest corner of the bounds
//     [29.8543 + 0.1, 77.8880 + 0.1], // northEast corner of the bounds
//   ];
...
//             <MapContainer
//               center={[29.8543, 77.8880]} // Adjust based on your desired center
  ...
  useEffect(() => {
    const fetchGeoJSON = async () => {
      try {
        // Ensure the file path is correct
        const response = await fetch(
         "/Corrected_Webtool_layers/Roorkee_fields_bhoomiscore_monthly_ndvi_complete.geojson"
        );
